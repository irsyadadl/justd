                ...
                <div className="flex items-center gap-x-1">
                  <>
                    ...
                    <Menu>
                      ...
                      >
                        {pathname.includes("/docs/") ? pathname.split("/")[2] : app.currentVersion}
...
export function NavbarDropdown() {
  ...
  return (
    <div className="flex items-center gap-x-1">
      <Menu>
        <Button aria-label={app.name} appearance="plain" className="-ml-1 group">
          <span className="flex items-center gap-x-2">
            <IconBrandJustd className="-ml-1 size-4.5" />
            <span className="font-mono text-base tracking-tight sm:text-sm">{app.name}</span>
        ...
        <Menu.Content placement="bottom" className="sm:min-w-64">
          ...
          <Menu.Section>
            ...
            <Menu.Item href={app.discord} target="_blank">
