        ...
        <Container>
          <Header>
            ...
            <p className="block max-w-3xl max-w-xl text-base text-muted-fg leading-relaxed md:leading-relaxed lg:text-xl [&_strong]:font-medium">
              <strong className="text-fg">{app.name}</strong> is a chill set of React components,
              built on top of <strong className="text-fg">React Aria Components</strong>, all about
              keeping the web accessible. Easy to customize and just copy & paste into your React
              projects. Plus, it includes <strong className="text-fg">Tailwind CSS</strong> for
